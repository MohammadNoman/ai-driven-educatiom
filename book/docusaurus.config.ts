...
const config: Config = {
  title: 'AI-Driven Education: A Live Book',
  tagline: 'Executable specifications for the future of learning',
  ...
  baseUrl: '/ai-driven-educatiom/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'mohammadnoman', // Usually your GitHub org/user name.
  projectName: 'ai-driven-educatiom', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/mohammadnoman/ai-driven-educatiom/tree/main/book/',
        },
        blog: {
